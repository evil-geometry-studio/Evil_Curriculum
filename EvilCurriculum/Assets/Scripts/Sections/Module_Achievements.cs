...
public class Module_Achievements : MonoBehaviour,IModule
{
    GameObject nextBtn;
    GameObject backBtn;
    ...
    private void Start() 
    {
        nextBtn = GameObject.Find("Canvas/Achievements_UI/BtnNext");  
        backBtn = GameObject.Find("Canvas/Achievements_UI/BtnBack");
